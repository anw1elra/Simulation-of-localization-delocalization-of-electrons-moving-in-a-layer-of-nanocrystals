...
const U0: f64 = -0.1; // depth of QD potential well, eV
const A: f64 = 60.0; // quantum dot size x, nm
const B: f64 = 30.0; // quantum dot size y, nm
...
const MAGNETIC: f64 = 0.0; // magnetic field induction, eV*fs/nm^2, max = 10.0 * 1e-3;
